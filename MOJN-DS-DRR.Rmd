...
``` {r flowcatmap, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = capFig("Map of flow categories at springs in each park.")}
if (params$isAccessible == "yes") {
...
These box plots show the median and quartile values for water temperature (C) for each park and 3-year cycle. Data flagged as “Warning” or “Critical” are not included.
...
This map shows water temperature (C) at annual and three year springs where water was present. If there is a field season slider at the top of the map, then data from a specific field season may be selected. If there is no field season slider, then data from the most recent field season are shown.

``` {r tempmap, message = FALSE, fig.cap = capFig("Map of water temperature readings at springs in each park.")}
...
This map shows specific conductance (uS/cm) at annual and three year springs where water was present. If there is a field season slider at the top of the map, then data from a specific field season may be selected. If there is no field season slider, then data from the most recent field season are shown.

``` {r spcondmap, message = FALSE, fig.cap = capFig("Map of specific conductance readings at springs in each park.")}
...
This map shows pH at annual and three year springs where water was present. If there is a field season slider at the top of the map, then data from a specific field season may be selected. If there is no field season slider, then data from the most recent field season are shown.

``` {r phpmap, message = FALSE, fig.cap = capFig("Map of pH readings at springs in each park.")}
...
This map shows dissolved oxygen concentration (mg/L) at annual and three year springs where water was present. If there is a field season slider at the top of the map, then data from a specific field season may be selected. If there is no field season slider, then data from the most recent field season are shown.

``` {r domap, message = FALSE, fig.cap = capFig("Map of dissolved oxygen concentration readings at springs in each park.")}
...
``` {r lifeformsperspringplot, fig.height = 8, warning = FALSE, fig.cap = capTab("Vegetation lifeform observations for each park and field season.")}
