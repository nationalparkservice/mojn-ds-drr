...
* **`r params$dataPackage1Title`.** Comma-separated text files containing data from the MOJN I&M Desert Springs protocol. These data were compiled by the MOJN I&M and were last updated on `r params$date`. Available at `r paste0("https://irma.nps.gov/DataStore/Reference/Profile/", params$dataPackage1RefID)`. 
...
``` {r flowcat3yrheatmap.1, out.height = 1450, warning = FALSE, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in DEVA.")}
...
``` {r flowcat3yrheatmap.2, out.height = 650, warning = FALSE, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in DEVA.")}
...
``` {r flowcat3yrheatmap.3, out.height = 800, warning = FALSE, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in LAKE.")}
...
``` {r flowcat3yrheatmap.4, out.height = 800, warning = FALSE, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in MOJA.")}
...
``` {r flowcat3yrheatmap.5, out.height = 800, warning = FALSE, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in PARA.")}
