...
``` {r figure1, echo = FALSE, fig.align = "left", fig.cap = "**Figure 1.** Examples of springs in the Mojave Desert.", height = 480, fig.alt = "Twelve photos of diverse springs across the network parks."}
...
``` {r figure2, echo = FALSE, fig.align = "left", fig.cap = "**Figure 2.** Desert springs monitoring locations. Blue circles indicate springs monitored every year. Red circles indicate springs monitored every three years.", fig.alt = "Map of 248 springs monitored by MOJN I&M across the five network parks."}
...
``` {r visitdate.timeline.1, warning = FALSE, out.height = 1600, fig.alt = ""}
...
``` {r visitdate.timeline.2, warning = FALSE, out.height = 800, fig.alt = ""}
...
``` {r visitdate.timeline.3, warning = FALSE, out.height = 800, fig.alt = ""}
...
``` {r visitdate.timeline.4, warning = FALSE, out.height = 800, fig.alt = ""}
...
``` {r visitdate.timeline.5, warning = FALSE, out.height = 800, fig.alt = ""}
...
``` {r sensorheatmap, out.height = 1000}
...
``` {r flowcatannualheatmap.1, out.height = 600, warning = FALSE}
...
``` {r flowcatannualheatmap.2, out.height = 350}
...
``` {r flowcatannualheatmap.3, out.height = 350}
...
``` {r flowcatannualheatmap.4, out.height = 350}
...
``` {r flowcatannualheatmap.5, out.height = 350}
...
``` {r flowcat3yrheatmap.1, out.height = 1450}
...
``` {r flowcat3yrheatmap.2, out.height = 650}
...
``` {r flowcat3yrheatmap.3, out.height = 800}
...
``` {r flowcat3yrheatmap.4, out.height = 800}
...
``` {r flowcat3yrheatmap.5, out.height = 800}
