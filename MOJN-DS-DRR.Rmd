...
params:
  ...
  dataPackage1Title: "MOJN I&M Desert Springs Data QC Report 2016-2023"               # Should match title in data store.
  dataPackage1Description: "MOJN I&M DS QC 2016-2023"  
...
``` {r figureold, eval = FALSE, echo = FALSE, fig.align = "left", fig.cap = capFig("Examples of springs in the Mojave Desert."), fig.asp = 0.52, fig.alt = "Twelve photos of diverse springs across the network parks."}
