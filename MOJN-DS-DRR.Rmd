...
``` {r flowcatannualheatmap.2, fig.height = 3, fig.cap = capFig("Heatmap of flow categories at annual springs in JOTR."), warning = FALSE}
...
``` {r flowcatannualheatmap.3, fig.height = 3, fig.cap = capFig("Heatmap of flow categories at annual springs in LAKE.")}
...
``` {r flowcatannualheatmap.4, fig.height = 3, fig.cap = capFig("Heatmap of flow categories at annual springs in MOJA.")}
...
``` {r flowcatannualheatmap.5, fig.height = 3, fig.cap = capFig("Heatmap of flow categories at annual springs in PARA.")}
...
``` {r flowcat3yrheatmap.1, warning = FALSE, fig.height = 10, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in DEVA.")}
...
``` {r flowcat3yrheatmap.2, warning = FALSE, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in JOTR.")}
...
``` {r flowcat3yrheatmap.3, warning = FALSE, fig.height = 6, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in LAKE.")}
...
``` {r flowcat3yrheatmap.4, warning = FALSE, fig.height = 6, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in MOJA.")}
...
``` {r flowcat3yrheatmap.5, warning = FALSE, fig.height = 6, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in PARA.")}
...
tempplot <- WqPlotDOmgL(field.season = year.range)
