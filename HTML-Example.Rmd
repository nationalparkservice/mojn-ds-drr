...
params:
  ...
  isInteractive: "no" # Either "yes" for a version with interactive plot formatting or "no" for a version with limited interactivity.
...
pagetitle: "MOJN DS DRR 2016-2023"
lang: "en"
title: |
...
The following background information is summarized from [*Springs in the Mojave Desert Network—Surface water monitoring at desert springs: Protocol narrative version 1.0* (NPS/MOJN/NRR—2018/1718)](https://irma.nps.gov/DataStore/Reference/Profile/2254900). Refer to the protocol narrative for more detailed information.
...
``` {r figure1, echo = FALSE, fig.align = "left", fig.cap = capFig("Examples of springs in the Mojave Desert."), height = 480, fig.alt = "Twelve photos of diverse springs across the network parks.", out.height = "100%"}
...
slick_dots <- slickR::slickR(
  ...
  height = 400,
  width = "60%"
  ) + slickR::settings(prevArrow = "<button class='slick-prev slick-arrow' aria-label='Previous image' type='button' style>",
...
* **`r params$dataPackage1Title`.** Comma-separated text files containing data from the MOJN I&M Desert Springs protocol. These data were compiled by the MOJN I&M and were last updated on `r format(Sys.Date(), '%B %d, %Y')`. Available on the NPS DataStore at [MOJN Streams and Lakes Data Package (2016-2023)](`r paste0("https://irma.nps.gov/DataStore/Reference/Profile/", params$dataPackage1RefID)`).
...
``` {r visitdate.timeline.1, warning = FALSE, fig.height = 10, out.width = "100%", fig.cap = capFig("Timeline of annual and 3-yr spring visits in DEVA."), fig.alt = "Placeholder"}
...
``` {r visitdate.timeline.2, warning = FALSE, out.width = "100%", fig.cap = capFig("Timeline of annual and 3-yr spring visits in JOTR."), fig.alt = "Placeholder"}
...
``` {r visitdate.timeline.3, warning = FALSE, out.width = "100%", fig.cap = capFig("Timeline of annual and 3-yr spring visits in LAKE."), fig.alt = "Placeholder"}
...
``` {r visitdate.timeline.4, warning = FALSE, out.width = "100%", fig.cap = capFig("Timeline of annual and 3-yr spring visits in MOJA."), fig.alt = "Placeholder"}
...
``` {r visitdate.timeline.5, warning = FALSE, out.width = "100%", fig.cap = capFig("Timeline of annual and 3-yr spring visits in PARA."), fig.alt = "Placeholder"}
...
reactable::reactable(springdischarge,
            columns = list(
              Notes = colDef(minWidth = 600),
              SiteCode = colDef(minWidth = 160),
              SiteName = colDef(minWidth = 200),
              SampleFrame = colDef(minWidth = 130),
              FlowCondition = colDef(minWidth = 120),
              VolDischarge_L_per_s = colDef(minWidth = 125),
              SpringbrookLengthFlag = colDef(minWidth = 160),
              DiscontinuousSpringbrookLengthFlag = colDef(minWidth = 150),
              DiscontinuousSpringbrookLength_m = colDef(minWidth = 150)
            ),
            sortable = TRUE,
            filterable = TRUE,
            compact = TRUE,
...
``` {r flowcatannualplot, fig.cap = capFig("Stacked bar plot of flow categories at annual springs for each park."), fig.alt = "Placeholder"}
...
``` {r flowcat3yrplot, fig.cap = capFig("Stacked bar plot of flow categories at 3-yr springs for each park."), fig.alt = "Placeholder"}
...
``` {r flowcatannualheatmap.1, fig.cap = capFig("Heatmap of flow categories at annual springs in DEVA."), warning = FALSE, fig.alt = "Placeholder"}
...
``` {r flowcatannualheatmap.2, fig.height = 3, fig.cap = capFig("Heatmap of flow categories at annual springs in JOTR."), warning = FALSE, fig.alt = "Placeholder"}
...
``` {r flowcatannualheatmap.3, fig.height = 3, fig.cap = capFig("Heatmap of flow categories at annual springs in LAKE."), fig.alt = "Placeholder"}
...
``` {r flowcatannualheatmap.4, fig.height = 3, fig.cap = capFig("Heatmap of flow categories at annual springs in MOJA."), fig.alt = "Placeholder"}
...
``` {r flowcatannualheatmap.5, fig.height = 3, fig.cap = capFig("Heatmap of flow categories at annual springs in PARA."), fig.alt = "Placeholder"}
...
``` {r flowcat3yrheatmap.1, warning = FALSE, fig.height = 10, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in DEVA."), fig.alt = "Placeholder"}
...
``` {r flowcat3yrheatmap.2, warning = FALSE, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in JOTR."), fig.alt = "Placeholder"}
...
``` {r flowcat3yrheatmap.3, warning = FALSE, fig.height = 6, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in LAKE."), fig.alt = "Placeholder"}
...
``` {r flowcat3yrheatmap.4, warning = FALSE, fig.height = 6, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in MOJA."), fig.alt = "Placeholder"}
...
``` {r flowcat3yrheatmap.5, warning = FALSE, fig.height = 6, fig.cap = capFig("Heatmap of flow categories at 3-yr springs in PARA."), fig.alt = "Placeholder"}
...
``` {r flowcatmap, fig.cap = capFig("Map of flow categories at springs in each park."), fig.alt = "Placeholder"}
flowcatmap <- FlowCategoriesMap(field.season = year.range)
flowcatmap
```
...
``` {r wqstats, fig.cap = capTab("Water quality median and quartile values for each park and field season."), fig.alt = "Placeholder"}
...
``` {r tempplot, message = FALSE, fig.cap = capFig("Box plots of water temperature quartiles for each park and 3-year cycle."), fig.alt = "Placeholder"}
...
``` {r spcondplot, message = FALSE, warning = FALSE, fig.cap = capFig("Box plots of specific conductance quartiles for each park and 3-year cycle."), fig.alt = "Placeholder"}
...
``` {r phplot, message = FALSE, fig.cap = capFig("Box plots of pH quartiles for each park and 3-year cycle."), fig.alt = "Placeholder"}
...
``` {r doplot, message = FALSE, fig.cap = capFig("Box plots of dissolved oxygen concentration quartiles for each park and 3-year cycle."), fig.alt = "Placeholder"}
...
``` {r tempmap, message = FALSE, fig.alt = "Placeholder", fig.cap = capFig("Map of water temperature readings at springs in each park.")}
...
``` {r spcondmap, message = FALSE, fig.alt = "Placeholder"}
...
``` {r phpmap, message = FALSE, fig.alt = "Placeholder"}
...
``` {r domap, message = FALSE, fig.alt = "Placeholder"}
...
## Riparian vegetation and invasive plants {.tabset .tabset-pills}
...
reactable::reactable(invplants,
            columns = list(
              Notes = reactable::colDef(minWidth = 600),
              SiteCode = reactable::colDef(minWidth = 160),
              SiteName = reactable::colDef(minWidth = 200)
            ),
...
``` {r invplantmap, echo = FALSE, message = FALSE, warning = FALSE, fig.alt = "Placeholder"}
...
``` {r flowmodplot, fig.cap = capFig("Stacked bar plot of flow modification status at springs in each park."), fig.alt = "Placeholder"}
flowmodplot <- FlowModPlot(field.season = year.range)

if (params$isInteractive == "no") {
  flowmodplot
} else {
  p <- ggplotly(flowmodplot, tooltip = c("text"))
...
reactable::reactable(humanuseobs,
            columns = list(
              Notes = reactable::colDef(minWidth = 600),
              SiteCode = reactable::colDef(minWidth = 160),
              SiteName = reactable::colDef(minWidth = 200)
...
``` {r humanuseplot, fig.cap = capFig("Bar plots of human use disturbance observed at springs in each park."), fig.alt = "Placeholder"}
...
``` {r humanusemap, echo = FALSE, message = FALSE, warning = FALSE, fig.alt = "Placeholder"}
...
``` {r livestockplot, fig.cap = capFig("Bar plots of livestock disturbance observed at springs in each park."), fig.alt = "Placeholder"}
...
``` {r livestockmap, echo = FALSE, message = FALSE, warning = FALSE, fig.alt = "Placeholder"}
...
reactable::reactable(ungulatesevidence,
            columns = list(
              Notes = reactable::colDef(minWidth = 600),
              SiteCode = reactable::colDef(minWidth = 160),
              SiteName = reactable::colDef(minWidth = 200)
...
``` {r ungulatesmap, echo = FALSE, message = FALSE, warning = FALSE, fig.alt = "Placeholder"}
