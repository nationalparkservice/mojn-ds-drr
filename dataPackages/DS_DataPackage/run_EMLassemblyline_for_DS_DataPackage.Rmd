...
all_data <- desertsprings::LoadDesertSprings(data_path = here::here("data", "raw"), cache = FALSE)
```
...
species_col <- c("USDAPlantsCode")  # Names of columns with species data, as listed in cat_vars
name_type <- "scientific"  # "scientific" or "common"
codes_to_omit <- c("UNK")  # Species codes that aren't actual species - codes for unknown sp, no sp., etc.
...
geographic_description <- c("MOJN Desert Springs Monitoring")  # Change this to describe the location(s) surveyed

# Fill in these coordinates
northmost_lat <- c(39.13129)  
eastmost_long <- c(-113.15745)
southmost_lat <- c(33.65772)
westmost_long <- c(-118.16453)
